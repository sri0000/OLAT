...
<head>
	...
	<title>Online learning and training</title>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">OLAT</h1>
			</div>
					...
					<div class="slider-content">
						...
						<div class="text">     <!-- jquery typed effect -->
							...
							<div class="social-networks">
								<a href="https://www.facebook.com/profile.php?id=100078945776379&mibextid=ZbWKwL" class="fa fa-facebook"></a>
								<a href="https://mobile.twitter.com/Akash52360984" class="fa fa-twitter"></a>
								<a href="https://instagram.com/srisrii0000?igshid=ZDdkNTZiNTM=" class="fa fa-instagram"></a>
								<a href="" class="fa fa-reddit"></a>
								<a href="https://www.linkedin.com/in/sribharathi-s-7698a124a" class="fa fa-linkedin"></a>
         	...
         	<div class="row">
         		<div class="col-xs-12">
         			<div class="section-title text-center">
         				<h2><b>SERVICES</b></h2>
         				<p>
         		E-learning offers a convenient and flexible way to acquire knowledge and skills <br>anytime, anywhere, at your own pace, and through a variety of multimedia formats.
         				</p>
         			</div>
         		</div>
         	</div>
         	<div class="row">
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
         					Here you will find problem programs for practice and their implementation also which will improve coding skill.
         				</p>
         			</div>
         		</div>
<!-- 
