    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">OLAT</a>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <form method="POST" action="add_quize.php">
            ...
            <div class="form-group">
              <label for="text">choice_1 :</label>
              <input type="text" class="form-control"  name="opt1" placeholder="Enter choice_1">
            </div>

            <div class="form-group">
              <label for="text">choice_2 :</label>
              <input type="text" class="form-control"   name="opt2" placeholder="Enter choice_2">
            </div>


            <div class="form-group">
              <label for="text">choice_3 :</label>
              <input type="text" class="form-control"  name="opt3" placeholder="Enter choice_3">
            </div>

               <div class="form-group">
              <label for="text">choice_4 :</label>
              <input type="text" class="form-control"  name="opt4" placeholder="Enter choice_4">
            </div>
