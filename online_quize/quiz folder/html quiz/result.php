<?php
  ...
  echo '<div class="button-container"><button><a href="tcpdf/index.php">Go to Next Page</a></button></div>';
} else {
  // show the "Go Back" button
  echo '<div class="button-container"><button type="button" onclick="window.history.back()">Go Back</button></div>';
}
