...
<!-- ========================================================================================================================== -->
  ...
  <a class="navbar-brand text-white" href="../index.php">OLAT</a>
...
<ul id="myUL">
  <li><a href="quiz folder/html quiz/index.php">HTML</a></li>
  <li><a href="quiz folder/css quiz/index.php">CSS</a></li>

  <li><a href="#">JAVASCRIPT</a></li>
  <li><a href="quiz folder/java quiz/index.php">JAVA</a></li>
