...
.div1                           /* for title image*/
{
   ...
   position: relative;
    height: 700px;
    width: 1200px;
    background:url(uploadimg/programming2.jpg);
}
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navi">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li> <a href="" id="our-location" class="btn-success" >Logout</a></li>
				</ul>
          ...
          <div class="row row-30">
            <div class="col-md-4 col-xl-5">
              <div class="pr-xl-4"><a class="brand" href="index.html"><img class="brand-logo-light" src="images/agency/logo-inverse-140x37.png" alt="" width="140" height="37" srcset="images/agency/logo-retina-inverse-280x74.png 2x"></a>
                ...
                <p>olat is an excellent learning hub, dedicated to the programmer who want to explore.</p>


                <!-- Rights-->
                <p class="rights"><span>©  </span><span class="copyright-year">2023</span><span> </span><span>olat</span><span>. </span><span>All Rights Reserved.</span></p>
              </div>
            </div>
            <div class="col-md-4">
              <h5>Contacts</h5>
              <dl class="contact-list">
                <dt>Address:</dt>
                <dd>tksct,koduvilarppatty, theni 625531</dd>
              </dl>
              <dl class="contact-list">
                <dt>email:</dt>
                <dd><a href="mailto:#">sriirs963787@gmail.com</a></dd>
              </dl>
              <dl class="contact-list">
                <dt>phones:</dt>
                <dd><a href="tel:#">+91 9384239906</a> <span>or</span> <a href="tel:#">+91 9344988227</a>
                </dd>
              </dl>
            </div>
